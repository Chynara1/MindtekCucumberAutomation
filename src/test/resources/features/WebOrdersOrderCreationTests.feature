...
Feature: Validating calculate and Order creation functionalities
  ...
  Scenario Outline:  Validating create order functionality
    ...
    Examples:
      | product     | quantity | name        | street      | city    | state | zip   | cc              | expire date |
      | MyMoney     | 10       | John Doe    | 123 My Road | Chicago | Il    | 12345 | 123470987078880 | 12/22       |
      | FamilyAlbum | 5        | Patel Harsh | 124 My Road | Chicago | Il    | 12345 | 12345678900980  | 04/22       |
      | MyMoney     | 1        | Kim Yan     | 123 My Road | Chicago | Il    | 12345 | 12345678900980  | 02/22       |
