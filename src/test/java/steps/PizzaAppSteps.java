...
////        }
        BrowserUtils.selectDropdownByValue(pizzaAppPage.pizza1Box, data.get("Pizza").toString());//Pizza is Key
        ...
        if (data.get("Payment type").toString().equalsIgnoreCase("Credit Card")) {
        ...
        coast = pizzaAppPage.pizza1CoastBox.getAttribute("value");
...
//
    ...
    public void user_validates_that_order_is_created_with_success_message(String success, String pizza) {
        String expectedSuccessMessage = success + coast + pizza;
